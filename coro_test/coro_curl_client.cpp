...
class ClientBase{
    public:
        ...
        //virtual performRequestAsync
};

class WebClient final: public ClientBase
{
    public:
    WebClient();
    ~WebClient();
    ...
    auto performRequestAsync(std::string url)
    {
...
Task doSomething(ClientBase& client)
{
    auto r1 = co_await static_cast<WebClient&>(client).performRequestAsync("https://postman-echo.com/get");
